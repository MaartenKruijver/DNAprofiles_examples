...
cdf.l <- dists.product.cdf.appr(si.fs.dist,appr.method=1) # `round' to lower values
cdf.u <- dists.product.cdf.appr(si.fs.dist,appr.method=2) # `round' to higher values
